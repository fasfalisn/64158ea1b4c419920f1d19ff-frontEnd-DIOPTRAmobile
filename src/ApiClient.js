...
class ApiClient {
    constructor() {
         ...
         * @type {String}
         * @default https://83.212.100.226:6007/v1
         */
        this.basePath = 'https://83.212.100.226:6007/v1'.replace(/\/+$/, '');
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "https://83.212.100.226:6007/v1",
              'description': "okthess-community-6007",
            }
      ];
    }
